...
add wave -noupdate -radix unsigned -childformat {{{/top/DUT/mem[15]} -radix unsigned} {{/top/DUT/mem[14]} -radix unsigned} {{/top/DUT/mem[13]} -radix unsigned} {{/top/DUT/mem[12]} -radix unsigned} {{/top/DUT/mem[11]} -radix unsigned} {{/top/DUT/mem[10]} -radix unsigned} {{/top/DUT/mem[9]} -radix unsigned} {{/top/DUT/mem[8]} -radix unsigned} {{/top/DUT/mem[7]} -radix unsigned} {{/top/DUT/mem[6]} -radix unsigned} {{/top/DUT/mem[5]} -radix unsigned} {{/top/DUT/mem[4]} -radix unsigned} {{/top/DUT/mem[3]} -radix unsigned} {{/top/DUT/mem[2]} -radix unsigned} {{/top/DUT/mem[1]} -radix unsigned} {{/top/DUT/mem[0]} -radix unsigned}} -subitemconfig {{/top/DUT/mem[15]} {-radix unsigned} {/top/DUT/mem[14]} {-radix unsigned} {/top/DUT/mem[13]} {-radix unsigned} {/top/DUT/mem[12]} {-radix unsigned} {/top/DUT/mem[11]} {-radix unsigned} {/top/DUT/mem[10]} {-radix unsigned} {/top/DUT/mem[9]} {-radix unsigned} {/top/DUT/mem[8]} {-radix unsigned} {/top/DUT/mem[7]} {-radix unsigned} {/top/DUT/mem[6]} {-radix unsigned} {/top/DUT/mem[5]} {-radix unsigned} {/top/DUT/mem[4]} {-radix unsigned} {/top/DUT/mem[3]} {-radix unsigned} {/top/DUT/mem[2]} {-radix unsigned} {/top/DUT/mem[1]} {-radix unsigned} {/top/DUT/mem[0]} {-radix unsigned}} /top/DUT/mem
