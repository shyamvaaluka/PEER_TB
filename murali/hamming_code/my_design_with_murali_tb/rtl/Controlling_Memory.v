...
module Memory_Control_Unit#(  parameter DATA_A       = 12,
                              ...
                              parameter ENCODED_WORD = DATA_A + PARITY_BITS
                                  ...
                                  input                     i_ena,i_enb,                     // Enable signals for port-a and port-b.
	                                ...
	                                input  [ENCODED_WORD+1:1] i_data_in_a,                     // Input data for port-a.
	                                input  [ENCODED_WORD+1:1] i_data_in_b,                     // Input data for port-b.
	                                output [ENCODED_WORD+1:1] BANKA_1,BANKA_2,BANKA_3,BANKA_4, // Port-a bank outputs of all the 4 banks.
	                                output [ENCODED_WORD+1:1] BANKB_1,BANKB_2,BANKB_3,BANKB_4  // Port-b bank outputs of all the 4 banks.
                               );
